                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select {{$errors->has('selectrol') ? 'is-invalid' : ''}}" aria-label="Default select example" id="selectrol" name="selectrol">
                                    <option value="">Seleccione rol</option>
                                    @foreach ($Role as $ro)
                                        <option value="{{$ro->name}}" @selected(old('selectrol') == $ro->name)>{{$ro->name}}</option>
                                    @endforeach
                                </select>
                                <div class="invalid-feedback">
