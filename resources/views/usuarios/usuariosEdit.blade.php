        ...
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-md-11">
                ...
                <form action="{{ route('update.usuario',['id' => $User->id]) }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control {{$errors->has('name') ? 'is-invalid' : ''}}" type="text" id="name" name="name" value="{{ old('name',$User->name)}}" required>
                                <div class="invalid-feedback">
                                    @if($errors->has('name'))
                                        {{$errors->first('name')}}
                                    @endif
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control {{$errors->has('email') ? 'is-invalid' : ''}}" type="email" id="email" name="email" value="{{ old('email',$User->email)}}" required>
                                <div class="invalid-feedback">
                                    @if($errors->has('email'))
                                        {{$errors->first('email')}}
                                    @endif
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control {{$errors->has('password') ? 'is-invalid' : ''}}" type="password" id="password" name="password" value="{{ old('password',$User->password)}}" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="password-confirm" type="password" class="form-control {{$errors->has('password-confirm') ? 'is-invalid' : ''}}" name="password_confirmation" required autocomplete="new-password" value="{{ old('password_confirmation',$User->password)}}">
                                <div class="invalid-feedback">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button class="btn btn-primary"><i class="bi bi-clipboard2-check"></i> Actualizar usuario</button>
                        </div>
                    </div>
                </form>
            </div>
...
<script>
    @if ($User->idpersona != null)
        seleccionarpersona({{$User->personas->id}},'{{$User->personas->cedula}}','{{$User->personas->nombres}}','{{$User->personas->apellidos}}');
    @endif

    let token = "{{csrf_token()}}";

    var modalPersona = new bootstrap.Modal(document.getElementById('modalPersona'), options)
    ...
    function seleccionarpersona(id,cedula,nombres,apellidos){
        ...
        //var myModalEl = document.querySelector('#modalPersona')
